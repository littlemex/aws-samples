...
# CDKアウトプットから値を取得して設定
    ...
    if env_vars['AWS_ACCOUNT_ID'] and env_vars['AWS_REGION'] and not env_vars['ECR_REPO']:
        env_vars['ECR_REPO'] = f"{env_vars['AWS_ACCOUNT_ID']}.dkr.ecr.{env_vars['AWS_REGION']}.amazonaws.com/rembg-async"
