...
本ワークショップでは、AI コーディング支援エージェント Cline を使用して開発生産性を向上させる方法を学びます。参加者は自身の AWS アカウントを利用して環境を構築します。ワークショップ参加にあたっての事前準備や環境要件については、[prerequisites.md](./prerequisites.md) を必ずご確認ください。
